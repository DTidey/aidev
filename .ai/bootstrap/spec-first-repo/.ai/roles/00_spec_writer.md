...
- Before writing, restate the problem, goal, affected area, and expected outcome as the spec's
  opening context.
- Read existing code and specs relevant to the request before proposing scope or acceptance
  criteria.
- Use the next available two-digit prefix for a new packet and keep that prefix stable once
  assigned.
...
## Definition of Done
- Spec includes: scope, non-goals, API/behavior, acceptance criteria, security considerations,
  edge cases, test guidance
